"""Deterministic grounded explanations — template fallback for the LLM path.

Takes the ranked Candidate list only — never queries the DB. Builds short
prose from specs + best-matching snippets so /recommend works without an LLM.
"""
